  ...
  async function init() {
    ...
    try {
      ...
      document.getElementById('user-avatar').textContent = (user.username || myName)[0].toUpperCase();
  ...
  document.addEventListener('keydown', e => {
    ...
    if (e.key === 'Escape') {
      closeSearch(); closeHelpModal(); closeMembersModal(); closeCreateBoardModal(); closeBoardMenu();
    }
  });
  ...
  function defineActions(obj) { Object.assign(__actions, obj); }
  window.__defineActions = defineActions;
  ...
  defineActions({
    ...
    toggleTheme, toggleNotifications, openSearch, openHelpModal, closeHelpModal,
